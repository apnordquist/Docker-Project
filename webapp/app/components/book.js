  ...
  return (
    <li className="flex flex-col w-96 p-2 m-4 bg-teal-950 rounded-md">
      ...
      <div className="flex flex-row">
        ...
        <div className="w-48 h-14 m-4 bg-rose-400 text-white text-center rounded-md hover:bg-red-600 disabled:bg-stone-300">
          <button
            className="w-full h-full"
            type="submit"
